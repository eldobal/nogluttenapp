...
class AlertDialogUbication extends StatefulWidget {
  @override
  _AlertDialogUbicationState createState() => _AlertDialogUbicationState();
}

class _AlertDialogUbicationState extends State<AlertDialogUbication> {
  @override
     ...
     builder: (context, provider, child) =>
         AlertDialog(
           ...
           title: Center(
             child: Column(
               children: [
                 lottie.Lottie.asset('assets/lotties/ubication.json',
